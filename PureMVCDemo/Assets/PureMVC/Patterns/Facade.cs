namespace PureMVC.Patterns
{
    ...
    public class Facade : IFacade
    {
        ...
        {
            UnityEngine.Debug.Log("4. Facade -> NotifyObservers");
            UnityEngine.Debug.Log(notification.ToString());
        ...
        {
            UnityEngine.Debug.Log("3. Facade -> SendNotification");
            this.NotifyObservers(new Notification(notificationName));
        }

        public void SendNotification(string notificationName, object body)
        {
            UnityEngine.Debug.Log("3.1. Facade -> SendNotification");
